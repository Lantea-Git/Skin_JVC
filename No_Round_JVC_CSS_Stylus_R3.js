...
style.textContent = `
    ...
    .messageEditor__containerEdit {
        ...
        #page-messages-forum .container__navTop {
            order : 1;
            margin-bottom: 1rem;
            font-size: 1rem;
        }
        ...
        #page-messages-forum #forums-settings-app {
            margin-left: auto;
        }

        #page-messages-forum .userParameters {
            border : none;
        }

        #page-messages-forum .buttonIconSwitch--isActive {
            color : inherit;  
        }

        @media (min-width: 612px) {
            #page-messages-forum .backTo__icon {
                visibility : hidden;
            }
        }
